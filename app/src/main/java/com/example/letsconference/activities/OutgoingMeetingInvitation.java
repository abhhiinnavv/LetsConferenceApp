...
import com.example.letsconference.network.ApiClient;
import com.example.letsconference.network.ApiService;
            ...
            public void onResponse(@NonNull Call<String> call, @NonNull Response<String> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (type.equals(Constants.REMOTE_MSG_INVITATION)) {
                        ...
                        Toast.makeText(OutgoingMeetingInvitation.this, "Invitation Cancelled", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                } else {
